...
function Hero() {
  ...
  const totalVideos = 4;
  const nextViedeoRef = useRef(null);
  ...
  function getVideoSrc(index) {
    return `videos/Hero/hero-${index}.mp4`;
  }
    ...
    () => {
      if (hasClicked) {
        ...
        gsap.to("#next-video", {
          ...
          duration: 1,
          ease: "power1.inOut",
          onStart: () => nextViedeoRef.current.play(),
        });
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              Own it, Shine everywhere
              <br />
              with the economey pirces
            </p>
            <Link to={"/products"}>
              <Button
                id="watch-trailer"
